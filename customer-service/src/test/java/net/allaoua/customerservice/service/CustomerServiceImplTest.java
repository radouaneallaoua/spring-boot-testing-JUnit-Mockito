package net.allaoua.customerservice.service;
...
import net.allaoua.customerservice.services.CustomerServiceImpl;
...
class CustomerServiceImplTest {
    ...
    void shouldSaveNewCustomer() {
        ...
        Mockito.when(customerMapper.toCustomerDTO(savedCustomer)).thenReturn(expected);
    ...
    void shouldFindCustomerById() {
        ...
        Mockito.when(customerMapper.toCustomerDTO(customer)).thenReturn(expected);
    ...
    void updateCustomer() {
        ...
        Mockito.when(customerMapper.toCustomerDTO(updatedCustomer)).thenReturn(expected);
